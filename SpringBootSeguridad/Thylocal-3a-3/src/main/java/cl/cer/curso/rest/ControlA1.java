...
import cl.cer.curso.services.dto.FileList;
import cl.cer.curso.services.dto.FileService;
import jakarta.servlet.http.HttpServletRequest;

@RestController
@RequestMapping(path = ControlA1.URI_PREFIX)
public class ControlA1 {


	private static final Logger LOG = LoggerFactory.getLogger(ControlA1.class);
	...
	public ResponseEntity<Resource> downloadFile(){
		...
		try { 
			...
			Resource resource = fileService.laodFileAsResource(filePath); 
